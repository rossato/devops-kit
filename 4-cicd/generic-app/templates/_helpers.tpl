...
{{- .Values.repository }}
{{- else -}}
image-registry.openshift-image-registry.svc:5000/{{ .Values.image.namespace | default .Release.Namespace }}/{{ .Values.image.name | default (include "generic-app.fullname" .) }}
{{- end }}
{{- end }}
